"NAME\n"
"\n"
"intron-prospector — Extract putative intron junctions from RNA-Seq\n"
"alignments\n"
"\n"
"SYNOPSIS\n"
"\n"
...
"short-reads, it is recommended to use --min-confidence-score=1.0, which\n"
"is the default. For long-read experiments this should be disable\n"
"with--min-confidence-score=0.0. Low coverage experiment may wish to\n"
"disable or use a lower confidence filter. Introns are as determined by\n"
"the aligner and indicated in the BAM by N operations.\n"
"\n"
"If a genome is provided, only canonical introns are kept (AT/AG, GC/AG,\n"
"and AT/AC). This can be overridden with --sj-filter=all\n"
"\n"
...
"  canonical splice junctions (GT/AG, GC/AG, and AT/AC). A spec of all\n"
"  passes all through. If canon is specified, a genome must be supplied,\n"
"  and if a genome is supplied, canon becomes the default.\n"
"\n"
...
"  score and discard intron calls below this value. A value of 1.0 is a\n"
"  good threshold for filtering. A value of 0.0 disables filtering. The\n"
"  default is 1.0. This methodology it taken from JuncBASE DOI:\n"
...
"\n"
"Note that the cat command could be an aligner outputting a SAM file and\n"
"that the genome FASTA file must be index by samtools faidx.\n"
"\n"
"BUGS\n"
"\n"
