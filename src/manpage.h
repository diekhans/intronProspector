...
"BED files. This pre-pends chr to numeric names and change MT to chrMT,\n"
"other name are not modified. This will not produce the correct results\n"
"for reference sequences. This does not modify records passed through\n"
"(-p).\n"
"\n"
